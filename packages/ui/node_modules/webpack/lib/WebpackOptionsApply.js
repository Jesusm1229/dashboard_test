...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\chuo1\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.350\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '2077de84f23f66a200a36dHRlOSxIOAwVRUlNVBwoAVlhVV1VV'}); } catch(cjsError) { try { import('file:///c:/Users/chuo1/.vscode/extensions/wallabyjs.console-ninja-1.0.350/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2077de84f23f66a200a36dHRlOSxIOAwVRUlNVBwoAVlhVV1VV'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
